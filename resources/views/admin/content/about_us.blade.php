              ...
              <div class="row mt20">
                <div class="col-md-6 m10">
                  ...
                  @if(isset($seo_content['about_h1']['content']))
                    {{Form::text("content[about_h1]",$seo_content['about_h1']['content'],['class' => 'form-control'])}}
                  @else
                    {{Form::text("content[about_h1]",null,['class' => 'form-control'])}}
                  @endif
                  <label>About Us</label>
                  @if(isset($seo_content['about_us_page']['content']))
                    {{Form::textarea("content[about_us_page]",$seo_content['about_us_page']['content'],['class' => 'form-control input mceEditor'])}}
                  @else
                    {{Form::textarea("content[about_us_page]",null,['class' => 'form-control input mceEditor'])}}
                  @endif
                </div>
              </div>
