...
<div class="main-content-container container-fluid px-4">
  ...
  <div class="page-header row no-gutters py-4">
    <div class="col-8 col-sm-8 text-center text-sm-left mb-0">
      <h3 class="page-title">Redirection Add</h3>
    </div>
  </div>
  <!-- End Page Header -->
  <!-- Default Light Table -->
      ...
      <div class="card card-small mb-4">
        <ul class="list-group list-group-flush">
          <li class="list-group-item p-3">
            ...
            {!! Form::open(['route' => 'admin.redirection.store','class'=>'form']) !!}
              ...
              <div class="row mt20">
                <div class="col-12 col-md-12">
                  <label>Status</label>
                    {{Form::select("status",[0=>'Disabled',1=>'Enabled'],1,['class' => 'form-control input','required'=>''])}}
                </div>
              </div>
