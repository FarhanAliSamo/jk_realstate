    ...
    <div class="container-xxl py-5">
        <div class="container">
            ...
            <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
                <h1 class="mb-3">Property Types testing</h1>
    ...
    <section class="private-aboutus">
        <div class="home container">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                    <div class="ab-heading">
                        ...
                        <div data-aos="fade-up" data-aos-duration="1500">
                            ...
                            <h5>{{ $basic_details->company_name }}</h5>
                        </div>
                        ...
                        <div class="abss" data-aos="fade-up" data-aos-duration="1500">
                ...
                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 ab-img">
                    <div data-aos="flip-left" data-aos-duration="1500">
                        <div class="cer-img-div">

                            @if (isset($seo_content['company_image1']['content']))
                                <img src="/uploads/images/{{ $seo_content['company_image1']['content'] }}"
                                    alt="{{ $basic_details->name }}" class="ab-img-sec img-fluid">
                            @endif
    ...
    <section class="service-style-two sec-pad">
        <div class="auto-container">
            ...
            <div class="row clearfix">
                ...
                @foreach ($industries as $key => $f_ind)
                    <div class="col-lg-4 col-md-6 col-sm-12 service-block mt-4">
                        <div class="service-block-two wow fadeInUp animated" data-wow-delay="00ms"
                            data-wow-duration="1500ms">
                            <div class="inner-box">
                                <figure class="image-box"><img src="/uploads/images/categories/{{ $f_ind->featured_image }}"
                                        alt="{{ $f_ind->name }}"></figure>
                                <div class="content-box">

                                    <div class="inner">
                                        <div class="text">
                                            <h3><a href="/product-category/{{ $f_ind->slug }}">{{ $f_ind->name }}</a></h3>
                                        </div>
                                    </div>
                                    <div class="link"><a href="/product-category/{{ $f_ind->slug }}"><i
                                                class="flaticon-right-arrow"></i><span>View Details</span></a></div>
                                </div>
    ...
    <div class="industry-served">
        <div class="container">
            <div class="section-intro ">
                ...
                <p>
                    At chemtexglobal, we cordially cater to our prestigious customers
                    in the following different industries. We deliver our products to diverse industries
                    with top-tier industrial product solutions.
                </p>
            </div>
            <div class="row">
                <div class="col-md-3 industry-item">
                    <div class="industry-card">
                        <img src="/images/textile.png" alt="Textile Industry">
                ...
                <div class="col-md-3 industry-item">
                    <div class="industry-card">
                        <img src="/images/appliance.png" alt="Food Processing Industry">
                        <p>Appliance Industry</p>
                    </div>
                </div>
                <div class="col-md-3 industry-item">
                    <div class="industry-card">
                        <img src="/images/aviation.png" alt="Food Processing Industry">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 news-block">
                        <div class="news-block-one wow fadeInUp animated animated" data-wow-delay="00ms"
                            ...
                            <div class="inner-box">
                                ...
                                <h5><a
                                        href="blog/chemical-safety-and-risk-management-industry-best-practices">{{ $value->title }}</a>
                                </h5>
                                <figure class="image-box"><a href="{{ route('blogs.view', $value->slug) }}"
                                        title="{{ $value->title }}"><img
                                            src="{{ get_blogthumb_url_500('blogs/', $value->featured_image, 1) }}"
                                            alt="{{ $value->title }}"></a></figure>
                                <div class="btn-box">
                                    <a href="{{ route('blogs.view', $value->slug) }}" title="{{ $value->title }}"><i
                                            class="flaticon-right-arrow"></i>Read More</a>
                                </div>
                            </div>
                        </div>
                    </div>
